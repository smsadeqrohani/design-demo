...
const FeatureGrid = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      helpContent: '• کلیک روی دکمه خرید بسته کارت بسته تعطیلات ← هدایت به صفحه خرید بسته.\n• در صفحه خرید بسته: انتخاب دکمه پرداخت ← نمایش صفحه خرید موفق.\n\nدر تمام صفحات:\n• تمام منوهای هدر و فوتر قابل کلیک هستند.\n• با کلیک روی لوگوی فیلم‌نت به صفحه اصلی باز می‌گردید.'
    },
    {
      id: 8,
